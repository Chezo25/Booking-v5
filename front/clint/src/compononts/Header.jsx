...
const Header = () => {
  return (
    <div>
      ...
      <div className='flex gap-3 border border-gray-300 rounded-full py-3 px-6 shadow-md shadow-gray-300 cursor-pointer'>
        <div>Anywhere</div>
      ...
      <Link to={'/login'} className='flex items-center gap-3 border border-gray-300 rounded-full py-3 px-6 shadow-md'>
